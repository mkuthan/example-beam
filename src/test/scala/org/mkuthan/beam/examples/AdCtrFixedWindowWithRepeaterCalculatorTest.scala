...
class AdCtrFixedWindowWithRepeaterCalculatorTest extends PipelineSpec with TimestampedMatchers with ModelFixtures {

  import AdCtrFixedWindowWithRepeaterCalculator.calculateCtrByScreen
  ...
  val beginOfThirdWindow = "12:30:00"
  val endOfThirdWindow = "12:40:00"
  ...
  "Impression and then repeated click on-time" should "give ctr 1.0" in runWithContext { sc =>
    val adEvents = testStreamOf[AdEvent]
      .addElementsAtTime("12:01:00", anyImpression)
